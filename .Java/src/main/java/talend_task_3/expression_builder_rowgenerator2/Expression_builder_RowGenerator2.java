...
package talend_task_3.expression_builder_rowgenerator2;
...
public class Expression_builder_RowGenerator2 implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_TALEND_TASK_3_Expression_builder_RowGenerator2 = new byte[0];
		static byte[] commonByteArray_TALEND_TASK_3_Expression_builder_RowGenerator2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALEND_TASK_3_Expression_builder_RowGenerator2.length) {
					if (length < 1024 && commonByteArray_TALEND_TASK_3_Expression_builder_RowGenerator2.length == 0) {
						commonByteArray_TALEND_TASK_3_Expression_builder_RowGenerator2 = new byte[1024];
					} else {
						commonByteArray_TALEND_TASK_3_Expression_builder_RowGenerator2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALEND_TASK_3_Expression_builder_RowGenerator2, 0, length);
				strReturn = new String(commonByteArray_TALEND_TASK_3_Expression_builder_RowGenerator2, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TALEND_TASK_3_Expression_builder_RowGenerator2, 0, length);
				strReturn = new String(commonByteArray_TALEND_TASK_3_Expression_builder_RowGenerator2, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALEND_TASK_3_Expression_builder_RowGenerator2) {
...
///////////////////////    			
				...
				class tRowGenerator_1Randomizer {
					public String getRandomnewColumn() {
						...
						return "" + ((null == null && !"null".equals("null")) ? "Y" : "N") + "";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Expression_builder_RowGenerator2.class.getClassLoader().getResourceAsStream(
					"talend_task_3/expression_builder_rowgenerator2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 34152 characters generated by Talend Open Studio for Data Integration on the
 * 21 July 2024, 7:43:33 am IST
 ************************************************************************************************/